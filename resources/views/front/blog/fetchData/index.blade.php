            ...
            <div class="blog-item bg-light rounded overflow-hidden">
                ...
                <div class="p-4">
                    <div class="d-flex mb-3">
                        <small class="me-3"><i class="far fa-user text-primary me-2"></i>{{$row->user->name}}</small>
                        <small><i class="far fa-calendar-alt text-primary me-2"></i>{{ date('d F, Y', strtotime($row->tanggal_posting)) }}</small>
                    </div>
