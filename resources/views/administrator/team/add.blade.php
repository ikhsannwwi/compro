...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.team.save') }}" method="post" enctype="multipart/form-data" class="form"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 col-12">
                            <div id="sosmed">
                                ...
                                <div class="sosmed-list" index-element="0">

                                </div>
                                <input type="hidden" name="jumlah_sosmed" value="0" id="jumlah_sosmed">
