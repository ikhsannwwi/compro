...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.testimonial.update') }}" method="post" enctype="multipart/form-data" class="form"
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview-image thumbnail mb20">
                                        <img width="200px"
                                            src="{{ $data->img_url ? img_src($data->img_url, 'testimonial') : '' }}">
                                    </div>
                                    <div class="mt-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea name="keterangan" class="form-control" id="inputKeterangan" cols="30" rows="10" autocomplete="off" data-parsley-required="true">{{$data->keterangan}}</textarea>
                            </div>
                        </div>
                    </div>
