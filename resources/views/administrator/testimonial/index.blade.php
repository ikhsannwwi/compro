...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-4" style="display: flex; justify-content: flex-end;">
                        @if (isallowed('testimonial', 'add'))
                            <a href="{{ route('admin.testimonial.add') }}" class="btn btn-primary">Tambah Data</a>
                        @endif
                    </div>
    ...
    @include('administrator.testimonial.modal.detail')
@endsection
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function() {
                                // data_table.ajax.url(
                                //         '{{ route('admin.testimonial.getData') }}')
                                //     .load();
